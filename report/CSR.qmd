...
This work presents simulation of casino machines (slot machines).\
We create strategies to play maximizing profit and evaluate their efficiency.

![Is it...](pics/ocean.jpeg){fig-align="center" width="300"}

## Practiced skills

-   R programming. **Functional** code and **tidyverse style** where is possible. A bit of **OOP** with R6 classes.
